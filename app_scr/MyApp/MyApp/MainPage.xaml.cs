...
namespace MyApp
{
    public partial class MainPage : ContentPage
    {
        ...
        private string GetPublicPhotosPath();
        #if ANDROID
        {
            // 获取公共 Pictures 目录
            ...
            return Path.Combine(picturesDir.AbsolutePath, "MyCancerData");
        }
        #else
        private string GetPublicPhotosPath() => Path.Combine(FileSystem.AppDataDirectory, "MyCancerData");
        #endif
